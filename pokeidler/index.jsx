...
const PAGES = [
    ...
    { name: "team", title: "Party", img: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/rare-candy.png", canBeVisible: () => DATA.team.length > 0 },
    { name: "gym", title: "Gym", img: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/lucky-punch.png", canBeVisible: () => DATA.team.length > 0 },
...
const quest_starting_pokemon = new (function () {
    ...
    const choice = (name) => {
        DATA.addToParty(new Pokemon(name))
...
const REGIONS = [
    // kanto
    new Region(1816, 1660, 32, 32, "pallet-town", [quest_starting_pokemon]),
    ...
    return <div className="RegionMapView" >
        <div className="d-flex align-items-start">
            ...
            <div className="col" >
                <div className="container">
                    <div className="card-deck">
                        {currentRegion && currentRegion.getQuests()
                            .map(quest => <QuestView quest={quest} />)}
                        {currentRegion && currentRegion.getEncounters()
...
const App = () => {
    ...
    async function addToParty(e) {
        ...
        e.preventDefault()
        try {
            await DATA.addToParty(searchValue.toLowerCase())
            DATA.update()
        } catch (e) {
