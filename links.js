...
function createElement() {
    ...
    <my-card title='Youtube'    	url='https://www.youtube.com/channel/wolforce'          image='./images/youtube.jpg'></my-card>
    ...
    <my-card title='Steam'      	url='./other/circles'                                   image='./images/steam.webp'></my-card>
    <my-card title='Curseforge' 	url='./ActNatal2020'                                    image='./images/curseforge400.jpg'></my-card>
    
    <div class="separator">Other useful links</div>
    <my-card title='Desmos Graphic Calculator' url='https://www.desmos.com/calculator' image='./images/desmos.png'></my-card>
    `
}